        ...
        <div className="content">
            ...
            <div className="content__single">
                ...
                <Single
                    ...
                    title="View bids"
                    content="Receive free bids from our talented event junctions within seconds."
                />
                <Single
                    src="https://www.f-cdn.com/assets/main/en/assets/home/benefits/live-chat-v2.svg"
                    title="Live chat"
                    content="You can live chat with your event junctions to get constant updates on the progress of your work."
                />
            </div>
            <div className="content__single">
                <Single
