    ...
    return (
        <div className="footer">
            ...
            <div className="footer__bottom">
                ...
                <p>
                    event junction ® is a registered Trademark of event junction Technology Pty pmited (ACN 141 959 042) <br />
                    Copyright © 2020 event junction Technology Pty pmited (ACN 141 959 042)
                </p>
